...
?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('ablog ablog-4 mb-50 format-image'); ?>>
...
<?php else : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('bd-blog mb-50 format-image'); ?> data-wow-delay=".3s">
        <?php if (has_post_thumbnail()) : ?>
            <div class="bd-blog-img m-img">
                <a href="<?php the_permalink(); ?>">
                    <?php the_post_thumbnail('full', ['class' => 'img-responsive']); ?>
                </a>
            </div>
