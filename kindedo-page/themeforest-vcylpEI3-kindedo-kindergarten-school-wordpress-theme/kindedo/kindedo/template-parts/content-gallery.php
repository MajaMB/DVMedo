...
if (is_single()) : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('ablog ablog-4 mb-50 format-gallery'); ?>>
                ...
                <div class="swiper-wrapper">
                    <?php foreach ($post_gallery as $key => $image) : ?>
                        <div class="swiper-slide mblog_image">
                            <img src="<?php echo esc_url($image['url']); ?>" alt="<?php print esc_attr__('gallery image', 'kindedo'); ?>">
                        </div>
                    <?php endforeach; ?>
                </div>
                <!-- If we need navigation buttons -->
                <div class="bd-blog-navigation kd-blog-gallery">
                    <button class="swiper-blog-button slide-prev"><i class="far fa-chevron-left"></i></button>
                    <button class="swiper-blog-button slide-next"><i class="far fa-chevron-right"></i>
                </div>
            </div>
        <?php endif; ?>
...
<?php else : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('bd-blog mb-50 format-gallery'); ?> data-wow-delay=".3s">
        <?php if (!empty($post_gallery)) : ?>
            <div class="post_gallery blog_gallery_active swiper-container">
                <div class="swiper-wrapper">
                    <?php foreach ($post_gallery as $key => $image) : ?>
                        <div class="swiper-slide mblog_image m-img">
                            <img src="<?php echo esc_url($image['url']); ?>" alt="<?php print esc_attr__('gallery image', 'kindedo'); ?>">
                        </div>
                    <?php endforeach; ?>
                </div>
                <div class="bd-blog-navigation kd-blog-gallery">
                    <!-- If we need navigation buttons -->
                    <button class="swiper-blog-button slide-prev"><i class="far fa-chevron-left"></i></button>
                    <button class="swiper-blog-button slide-next"><i class="far fa-chevron-right"></i></button>
                </div>
            </div>
        <?php endif; ?>
