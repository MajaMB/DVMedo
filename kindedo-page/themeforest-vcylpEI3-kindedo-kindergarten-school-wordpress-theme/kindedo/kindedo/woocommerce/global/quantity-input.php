...
$label = !empty($args['product_name']) ? sprintf(esc_html__('%s quantity', 'kindedo'), wp_strip_all_tags($args['product_name'])) : esc_html__('Quantity', 'kindedo');
