...
(function ($) {
  ...
  $(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction("frontend/element_ready/cust-services-slider.default", ElserviceActive);
    elementorFrontend.hooks.addAction("frontend/element_ready/cust-team.default", ElteamActive);
    elementorFrontend.hooks.addAction("frontend/element_ready/cust-post-list.default", ElblogActive);
    elementorFrontend.hooks.addAction("frontend/element_ready/cust-project-slider.default", ElprojectActive);
    elementorFrontend.hooks.addAction("frontend/element_ready/cust-slider.default", ElsliderActive);
    elementorFrontend.hooks.addAction("frontend/element_ready/cust-testimonial-slider.default", EltestimonialActive);
    elementorFrontend.hooks.addAction("frontend/element_ready/cust-infobox.default", DataBackground);
  });
})(jQuery);
