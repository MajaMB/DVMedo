...
$tsingle_meta = get_theme_mod('tsingle_meta', true);
...
<div class="tutor-single-course-segment tutor-single-course-lead-info course-detalis-wrapper mb-30 sa">
        ...
        ?>
            <?php if (!empty($trating_show)) : ?>
                <div class="course-star">
                    <h5><?php echo esc_html__('Review:'); ?></h5>
                    <div class="tutor-single-course-rating">
                        ...
                        <?php if (!empty($trating_count)) : ?>
                            <span class="tutor-single-rating-count d-none">
                                <?php
                                echo kindedo_kses_intermediate($course_rating->rating_avg);
                                echo '<i>(' . kindedo_kses_intermediate($course_rating->rating_count) . ')</i>';
                                ?>
                            </span>
                        <?php endif; ?>
                    </div>
        ...
        <div class="course-detelis-meta">
            <div class="course-meta-wrapper border-line-meta">
                ...
                <div class="course-meta-text">
                    <span><?php _e('Teacher', 'kindedo'); ?></span>
            ...
            <div class="course-Enroll border-line-meta">
                <p><?php echo _e('Total Enrolled', 'kindedo'); ?></p>
                <span>
            ...
            <div class="course-update border-line-meta">
                <p><?php _e('Last Update:', 'kindedo'); ?></p>
    ...
    ?>
        <div class="tutor-course-summery">
            <h4 class="tutor-segment-title"><?php esc_html_e('About Course', 'kindedo') ?></h4>
            <?php print kindedo_kses_intermediate($excerpt); ?>
        </div>
    <?php
    }
    ?>
