...
if ($instructors){
	...
	?>
	<h4 class="tutor-segment-title tutor-segment-title-700"><?php $count>1 ? _e('About the instructors', 'kindedo') : _e('About the instructor', 'kindedo'); ?></h4>
			...
			<div class="single-instructor-wrap">
				<div class="single-instructor-top">
                    ...
                    <div class="tutor-instructor-right">
						...
						<div class="courses">
							<p>
								<?php echo tutor_utils()->get_course_count_by_instructor($instructor->ID); ?> <span class="tutor-text-mute"> <?php _e('Courses', 'kindedo'); ?></span>
							</p>
						</div>
						<div class="instructor-bio">
							<?php echo esc_html($instructor->tutor_profile_bio); ?>
						</div>
						<div class="kindedo-instructor-social mt-15">
							<?php 
