...
$kindedo_tutor_course_details_author_meta_switch = get_theme_mod('kindedo_tutor_course_details_author_meta_switch', true);
...
<div class="tutor-single-course-segment tutor-single-course-lead-info bb">
    ...
    <?php if (!empty($kindedo_tutor_course_details_author_meta_switch)) : ?>
        <div class="course__meta-2 d-sm-flex mb-30">
            ...
            <div class="course__update mr-80 mb-30">
                <h5><?php echo esc_html__('Last Update:', 'kindedo'); ?></h5>
            ...
            ?>
                <?php if (!empty($trating_show)) : ?>
                    <div class="course__rating-2 mb-30">
                        <h5><?php echo esc_html__('Review:', 'kindedo'); ?></h5>
    ...
    ?>
        <div class="tutor-course-summery">
            ...
            <?php echo kindedo_kses_intermediate($excerpt); ?>
        </div>
    <?php
    }
    ?>
