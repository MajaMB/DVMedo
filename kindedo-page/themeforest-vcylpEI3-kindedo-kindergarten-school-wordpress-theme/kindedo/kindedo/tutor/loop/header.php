      ...
      <div class="course-info-wrapper">
         <div class="cart-info-body">
            ...
            <div class="cart-lavel">
               <h5><?php print esc_html__('Level : ', 'kindedo'); ?> <span><?php echo get_tutor_course_level(); ?></span></h5>
               <?php the_excerpt(); ?>
            </div>
            
            <div class="course-action">
               <a href="<?php the_permalink(); ?>" class="view-details-btn"> <?php _e('View Details','kindedo'); ?></a>
                    <?php
                        $course_id = get_the_ID();
                ...
                <div class="tutor-modal-content tutor-modal-content-white">
                    ...
                    <div class="tutor-modal-body">
                        ...
                        <div class="etlms-course-share-modal-link tutor-color-black tutor-fs-6 tutor-fw-medium tutor-mb-16">
                             <h3><?php _e('Share on social media','kindedo'); ?></h3>
                        </div>
