<?php
    ...
    $filter_levels = array(
        'beginner'=> __('Beginner', 'kindedo'),
        'intermediate'=> __('Intermediate', 'kindedo'),
        'expert'=> __('Expert', 'kindedo')
    );
    $filter_prices=array(
        'free'=> __('Free', 'kindedo'),
        'paid'=> __('Paid', 'kindedo'),
    );
...
<form>  
    ...
    <?php
        if(in_array('search', $supported_filters)){
            ?>
            <div class="tutor-course-search-fields course__sidebar-search mb-40">
                <input type="text" name="keyword" placeholder="<?php _e('Search...','kindedo'); ?>"/>
    ...
    <div>
        <?php
            if(in_array('category', $supported_filters)){
                ?>
                <div class="course-sidebar-widget mb-40">
                    <div class="course-sidebar-info">
                    <h3 class="course__sidebar-title"><?php _e('Category', 'kindedo'); ?></h3>
            ...
            if(in_array('tag', $supported_filters)){
                ...
                <div class="course-sidebar-widget mb-40">
                    <div class="course-sidebar-info">
                    <h3 class="course__sidebar-title"><?php _e('Tag', 'kindedo'); ?></h3>
    ...
    <div>
        <?php
            if(in_array('difficulty_level', $supported_filters)){
                ...
                <div class="course-sidebar-widget mb-40">
                    <div class="course-sidebar-info">
                    <h3 class="course__sidebar-title"><?php _e('Level', 'kindedo'); ?></h3>
                    <?php 
            ...
            if(!$is_membership && in_array('price_type', $supported_filters)){
                ...
                <div class="course-sidebar-widget mb-40">
                    <div class="course-sidebar-info">
                    <h3 class="course__sidebar-title"><?php _e('Price', 'kindedo'); ?></h3>
                    <?php 
