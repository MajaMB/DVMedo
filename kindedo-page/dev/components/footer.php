                        ...
                        <div class="bd-footer-widget-content">
                           ...
                           <div class="bd-footer-list">
                              <ul>
                                 ...
                                 <li><a href="director-notes.php">Riječ ravnateljice</a></li>
                                 <li><a href="programs.php">Programi</a></li>
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     <div class="bd-footer-widget bd-footer-widget-3 mb-50">
                        <div class="bd-footer-widget-content">
                           ...
                           <div class="bd-footer-list">
                              <ul>
                                 <li><a href="enrolment.php">Upisi</a></li>
                                 <li><a href="menu.php">Jelovnik</a></li>
                                 <li><a href="application.php">Natječaji</a></li>
                                 <li><a href="news.php">Novosti</a></li>
                                 <li><a href="faq.php">Česta pitanja</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="bd-footer-widget-content">
                           ...
                           <div class="bd-footer-contact">
                              <ul>
                                 ...
                                 <li><i class="fa-light fa-phone"></i><a href="tel:042208000">042/ 208 – 000</a></li>
                                 <li><i class="fa-light fa-envelope"></i><a
                                       href="mailto:info@vrtic-medo.hr">info@vrtic-medo.hr</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
