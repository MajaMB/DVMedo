                        ...
                        <nav id="mobile-menu">
                           <ul>
                              ...
                              <!-- <li class="has-dropdown has-mega-menu">
                                 <a href="programs.php">Programi</a>
                                             ...
                                             <div class="mega-menu-2-inner-thumb p-relative">
                                                ...
                                                <div class="mega-menu-2-inner-thumb-content">
                                                   ...
                                                   <div class="mega-menu-2-inner-thumb-btn mb-25">
                                                      <a href="programs.php" class="mega-btn">View More</a>
                                                   </div>
                                                </div>
                                             </div>
                                          </li>
                              ...
                              <!-- <li class="has-dropdown has-mega-menu">
                                 <a>Dokumenti</a>
                                 <ul class="mega-menu">
                                    <li><a href="javasript:void(0);" class="mega-menu-title">Prvi set</a>
                                       <ul>
                                    ...
                                    <li><a href="javasript:void(0);" class="mega-menu-title">Drugi Set</a>
                                       <ul>
                                    ...
                                    <li><a href="javasript:void(0);" class="mega-menu-title">Treci Set</a>
                                       <ul>
                              ...
                              <li class="has-dropdown">
                                 <a>Dokumenti</a>
                                 <ul class="submenu">
                                    <li><a href="applications.php">Natječaji</a></li>
                                    <li><a href="pedagogical-documentation.php">Pedagoška dokumentacija</a></li>
                                 </ul>
                              </li>
                              <li>
