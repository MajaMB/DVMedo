               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="bd-promotion mb-60 wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
                     ...
                     <div class="bd-promotion-btn-wrapper flex-wrap">
                        ...
                        <div class="bd-promotion-btn">
                           <a href="/dokumenti/za-upise/prijavnica.pdf" class="bd-btn">
                              <span class="bd-btn-inner">
                     ...
                     <div class="swiper-wrapper">
                           ...
                           <div class="bd-program">
                              ...
                              <div class="bd-program-info-wrapper theme-bg">
                                 <div class="bd-program-info">
                                    <h5 class="bd-program-info-title">6-36 Mjeseci</h5>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="swiper-slide">
                           <div class="bd-program">
                              ...
                              <div class="bd-program-content mb-30">
                                 <h3 class="bd-program-title"><a class="hover-clr-2" href="program-details.html">Vrtić</a></h3>
                                 <p>Vrtić je čarobno mjesto gdje kreativnost cvjeta, a znatiželja vodi svaki korak.
                                 </p>
                              </div>
                              <div class="bd-program-info-wrapper theme-bg">
                                 <div class="bd-program-info">
                                    <h5 class="bd-program-info-title">3 godine - polaska u školu</h5>
                                 </div>
                              </div>
                           </div>
                        </div>
