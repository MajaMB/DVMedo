                        ...
                        <div class="bd-hero-thumb-3-wrapper p-relative z-index-1" data-depth=".4">
                           <div class="bd-hero-thumb-3 p-relative">
                              <div class="bd-hero-thumb-3-mask">
                                 <img src="assets/img/hero/hero-3.jpg" alt="img not found!">
                              </div>
                           </div>
         ...
         <div class="container">
            ...
            <div class="row justify-content-center">
               <div class="col-lg-8">
                  <div class="bd-section-title-wrapper text-center mb-55 wow fadeInUp" data-wow-duration="1s"
                     data-wow-delay=".2s">
                     <h2 class="bd-section-title mb-0">Naš program</h2>
                     <p>Vrtić otvoren 2024. godine s vizijom da kod djece potakne samostalno obavljanje zadatke kako bi izgradili samopouzdanje i autonomiju .</p>
                  </div>
               </div>
            </div>
            <div class="row">
                           ...
                           <div class="bd-program">
                              <div class="bd-program-thumb-wrapper">
                                 <a href="program-details.html">
                                    <div class="bd-program-thumb">
                                       <img src="assets/img/program/jaslice.jpg" alt="Image not found">
                                    </div>
                                 </a>
                              ...
                              <div class="bd-program-content mb-30">
                                 <h3 class="bd-program-title"><a class="hover-clr-1"
                                       href="program-details.html">Jaslice</a>
                                 </h3>
                                 <p>Jaslice su mjesto gdje mala srca rastu uz ljubav, njegu i beskrajne mogućnosti.</p>
                              </div>
                              <div class="bd-program-info-wrapper theme-bg">
                                 <div class="bd-program-info">
                                    <h5 class="bd-program-info-title">6-36 Mjeseci <br><span>starosti</span></h5>
                                 </div>
                                 <div class="bd-program-info">
                                    <h5 class="bd-program-info-title">5 dana <br><span>tjedno</span></h5>
                                 </div>
                                 <div class="bd-program-info">
                                    <h5 class="bd-program-info-title">6 sati<br><span>dnevno</span></h5>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="swiper-slide">
                           <div class="bd-program">
                              <div class="bd-program-thumb-wrapper">
                                 <a href="program-details.html">
                                    <div class="bd-program-thumb">
                                       <img src="assets/img/program/vrtic.jpg" alt="Image not found">
                                    </div>
                                 </a>
                                 <div class="bd-program-shape">
                              ...
                              <div class="bd-program-content mb-30">
                                 <h3 class="bd-program-title"><a class="hover-clr-2" href="program-details.html">Vrtić (mlađi)</a></h3>
                                 <p>Vrtić je čarobno mjesto gdje kreativnost cvjeta, a znatiželja vodi svaki korak.
                                 </p>
                              </div>
                              <div class="bd-program-info-wrapper theme-bg-2">
                                 <div class="bd-program-info">
                                    <h5 class="bd-program-info-title">3 - 5 Godina <br><span>starosti</span></h5>
                                 </div>
                                 <div class="bd-program-info">
                                    <h5 class="bd-program-info-title">5 dana <br><span>tjedno</span></h5>
                                 </div>
                                 <div class="bd-program-info">
                                    <h5 class="bd-program-info-title">8 sati<br><span>dnevno</span></h5>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="swiper-slide">
                           <div class="bd-program">
                              <div class="bd-program-thumb-wrapper">
                                 <a href="program-details.html">
                                    <div class="bd-program-thumb">
                                       <img src="assets/img/program/vrtic-stariji.jpg" alt="Image not found">
                                    </div>
                                 </a>
                                 <div class="bd-program-shape">
                              ...
                              <div class="bd-program-content mb-30">
                                 <h3 class="bd-program-title"><a href="program-details.html"
                                       class="hover-clr-3">Vrtić (stariji) </a>
                                 </h3>
                                 <p>Vrtić je mjesto gdje se temelji znanja i prijateljstva grade kroz igru i istraživanje.</p>
                              </div>
                              <div class="bd-program-info-wrapper theme-bg-3">
                                 <div class="bd-program-info">
                                    <h5 class="bd-program-info-title">5 - 7 Godina <br><span>dob</span></h5>
                                 </div>
                                 <div class="bd-program-info">
